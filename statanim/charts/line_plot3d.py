"""
statanim/charts/line_plot3d.py
==================================
...
--------------
    ...
    from manim import *
    from statanim.axes.grid3d import FullGrid3D
    from statanim.charts.line_plot3d import MultiLinePlot3D
    ...
    from statanim.charts.line_plot3d import CDFLine3D
    cdf = CDFLine3D(x_values=xs, cdf_values=ys, shade_above=1.96)

    # Parametric space curve
    from statanim.charts.line_plot3d import ParametricLine3D
