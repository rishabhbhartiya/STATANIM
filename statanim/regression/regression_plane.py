"""
statanim/regression/regression_plane.py
==========================================
...
::
    ...
    from statanim.regression.regression_plane import (
        RegressionPlane3D, ScatterCloud3D, PlaneResiduals3D, build_plane_scene,
    )
    from statanim.regression.correlation import ols_fit
    import numpy as np
...
# ---------------------------------------------------------------------------
try:
    from statanim.regression.correlation import (
        RegressionResult,
        ols_fit,
        influence_measures,
        InfluenceMeasures,
...
try:
    from statanim.core.tex_utils import (
...
def _require_corr(name: str) -> None:
    if not _CORR_AVAILABLE:
        raise ImportError(
            f"{name} requires statanim.regression.correlation."
        )
...
try:
    from statanim.regression.correlation import ols_fit as ols_fit
except ImportError:
    pass
