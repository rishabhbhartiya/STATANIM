...
# ── statanim imports (adjust path if needed) ──────────────────────────────
...
from statanim.props.coin import make_coin_row
from statanim.probability.venn3d import VennDiagram3D, VennData2, VennConfig
from statanim.probability.sample_space import SampleSpace3D, SampleSpaceConfig
from statanim.probability.bayes import (
    BayesBox3D, PriorPosteriorBar3D, BayesFormulaBanner,
    compute_joint_probs, build_bayes_scene,
)
from statanim.distributions.discrete_dists import (
    BinomialDistribution3D,
    HypergeometricDistribution3D,
)
from statanim.ui.labels import StatLabel3D, FormulaPanel3D
from statanim.ui.panels import InfoPanel3D, HypothesisPanel3D
from statanim.core.base import StatsTheme, StatsColorPalette
from statanim.core.colors import get_theme
...
# =========================================================================
    ...
    # ---------------------------------------------------------------------
    # Patch required by statanim distribution classes
    # ---------------------------------------------------------------------
        def data_to_scene_length(length, axis):
            if axis in ("x", 0):
                p1 = axes.c2p(0, 0, 0)
